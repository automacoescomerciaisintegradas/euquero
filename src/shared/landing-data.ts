  ...
  features: [
    {
      ...
      description: "Configure respostas automáticas para comentários em posts, Stories, Reels e Remixes",
      details: [
    ...
    },
    {
      ...
      description: "Respostas automáticas durante lives e conversão de espectadores em clientes",
      details: [
...
export const whatsappConfig: WhatsAppConfig = {
  ...
  defaultMessage: "Olá! Gostaria de saber mais sobre o EuQuero. Podem me ajudar?",
  teamName: "Equipe EuQuero",
  welcomeMessage: "Olá! Tem dúvidas sobre nossa plataforma? Estamos aqui para ajudar!"
};